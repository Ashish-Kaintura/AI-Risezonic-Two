...
const Hero = () => {
  ...
  return (
    <section className="relative rounded-lg shadow-xl overflow-hidden pt-28 h-[750px] mt-[120px] items-center">
      {/* Animated background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center space-y-8">
        <h1 className="text-5xl md:text-7xl font-extrabold text-white drop-shadow-lg tracking-tight min-h-[70px]">
        ...
        <p className="text-2xl md:text-3xl text-gray-800 font-medium max-w-2xl mx-auto">
          ...
          <span className="bg-gradient-to-r from-white via-white/60 to-white/80 bg-clip-text text-transparent font-bold">
            Generative AI
          </span>
        </p>
        <p className="text-lg text-black">Learn. Build. Innovate.</p>
