...
const projectsData = [
  {
    title: "Chat with PDF + CSV",
    image: "https://img.icons8.com/clouds/500/pdf.png",
    tag: "AI Tool",
  },
  {
    title: "Voice Controlled Robot with LLM",
    image: "https://img.icons8.com/clouds/500/robot.png",
    tag: "Robotics",
  },
  {
  ...
  {
    title: "AI Caller with Human-Like Voice",
    image: "https://img.icons8.com/clouds/500/phone.png",
    tag: "Voice AI",
  },
  {
    title: "WhatsApp AI Assistant",
    image: "https://img.icons8.com/clouds/500/whatsapp.png",
    tag: "Bot",
  },
];
...
const studentProjects = [
  {
    ...
    image: "https://img.icons8.com/clouds/500/report-card.png",
    tag: "Student Mini Startup",
  },
  {
    title: "College LMS Assistant",
...
const Card = ({ title, image, tag }) => (
  <div className="bg-white rounded-xl shadow hover:shadow-lg p-4 flex flex-col items-center text-center transition-all duration-300">
    <img src={image} alt={title} className="w-24 h-24 object-contain mb-4" />
    <h3 className="text-lg font-semibold text-gray-800">{title}</h3>
    <span className="text-sm mt-1 bg-blue-100 text-blue-700 px-3 py-1 rounded-full">
      {tag}
    </span>
  </div>
);
...
const OurProjects = () => {
  ...
  return (
    ...
    >
      <div
        className="pt-24 px-6 md:px-12 max-w-7xl mx-auto font-sans text-gray-800 py-16 my-4"
        style={{
      ...
      >
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-700 mb-2 flex items-center justify-center gap-2">
            <FaRobot /> Our Projects
          </h1>
          <p className="text-lg text-gray-600">
            Built by our team, students, and hackathon enthusiasts!
          </p>
        </div>

        {/* OUR PROJECTS */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 uppercase flex items-center gap-2">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 uppercase flex items-center gap-2">
            <FaGraduationCap /> Student-led Projects
          </h2>
        ...
        <div className="text-center mt-10">
          <a
            href="/projects"
            className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition text-sm inline-flex items-center gap-2 mr-4"
          >
          ...
          <a
            ...
            className="border border-blue-600 text-blue-600 px-6 py-2 rounded-lg hover:bg-blue-50 transition text-sm inline-flex items-center gap-2"
          >
            <FaGithub /> GitHub
          </a>
        </div>
