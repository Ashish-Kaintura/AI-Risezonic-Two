...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* <Testimonials /> */}
      {/* Call to Action */}
      {/* <section className="text-center py-12 bg-white space-y-8 ">
        <h2 className="text-2xl font-bold text-blue-700 mb-4">
          Want to bring AI to your institution or career?
        </h2>
        <div className="flex flex-wrap justify-center gap-4">
          <button className="px-6 py-2 bg-green-600 text-white rounded-full hover:bg-green-700">
            Schedule a Demo
          </button>
          <button className="px-6 py-2 border border-green-600 text-green-600 rounded-full hover:bg-green-50">
            Download Brochure
          </button>
