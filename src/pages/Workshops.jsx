...
//           <h1 className="text-4xl md:text-5xl font-bold mb-4">Host a Workshop</h1>
//           <p className="text-lg md:text-xl max-w-3xl mx-auto">
//             For Colleges, Schools & Corporate Teams – Bring future-ready learning to your campus or workplace
//           </p>
//           <div className="mt-8">
//             <iframe
...
//           <div>
//             <h2 className="text-2xl font-bold mb-3 text-purple-600">For Colleges & Universities</h2>
//             <p className="mb-4 text-lg">
//               Empower your students with skill-based, industry-aligned workshops that complement academic learning.
//             </p>
...
//               <strong>Ideal for:</strong> B.Tech, BCA, MCA, BSc (CS/IT), MBA, and interdisciplinary streams<br />
//               <strong>Includes:</strong> Certificates, project kits (if applicable), career orientation
//             </p>
//           </div>
//           <img
...
//           />
//           <div>
//             <h2 className="text-2xl font-bold mb-3 text-pink-600">For Schools (Grades 9–12)</h2>
//             <p className="mb-4 text-lg">
//               Make STEM exciting with age-appropriate, hands-on tech workshops designed to spark curiosity and creativity.
//             </p>
//             <ul className="list-disc list-inside space-y-1 text-sm">
//               <li>Introduction to AI & ChatGPT</li>
//               <li>Build Your First Robot</li>
...
//             </ul>
//             <p className="mt-3 text-sm text-gray-600">
//               <strong>Aligned with:</strong> NEP & CBSE Skill Education Goals<br />
//               <strong>Includes:</strong> Worksheets, demo kits, participation certificates
//             </p>
//           </div>
//         </div>
...
//         <div className="grid md:grid-cols-2 gap-10 items-center">
//           <div>
//             <h2 className="text-2xl font-bold mb-3 text-blue-600">For Corporate Teams & Professionals</h2>
//             <p className="mb-4 text-lg">
//               Upskill your workforce with customized, ROI-focused training in emerging technologies and tools.
//             </p>
//             <ul className="list-disc list-inside space-y-1 text-sm">
//               <li>Generative AI for Business</li>
//               <li>Power BI for Decision Makers</li>
...
//             </ul>
//             <p className="mt-3 text-sm text-gray-600">
//               <strong>Customizable for:</strong> tech, non-tech, HR, marketing, and leadership teams<br />
//               <strong>Includes:</strong> Live demos, Q&A, use-case labs, takeaway toolkits
//             </p>
//           </div>
//           <img
...
//           <h3 className="text-2xl font-bold mb-4 text-gray-800">What We Provide</h3>
