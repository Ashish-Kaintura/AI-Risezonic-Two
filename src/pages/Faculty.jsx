      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Faculty.map((Faculty, idx) => (
            <Link
              key={Faculty.id}
              to={`/faculty-development/${Faculty.id}`}
              data-aos="zoom-in-up"
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="text-xs text-gray-500 mb-1">
                  🎓 <strong>Certificate:</strong> {Faculty.certificate}
                </div>
                <div className="text-xs text-gray-500 mb-4">
                  💼 <strong>Careers:</strong> {Faculty.career.join(", ")}
                </div>
        ...
        {Faculty.length === 0 && (
          <div className="text-center text-gray-500 mt-16 text-lg">
            No Faculty found. Try another filter or search.
          </div>
        )}
      </div>
    </section>
